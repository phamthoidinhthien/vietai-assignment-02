...
class GradioAgentChatPack(BaseLlamaPack):
    ...
    def run(self, *args: Any, **kwargs: Any) -> Any:
        ...
        with demo:
            with gr.Row():
                gr.Markdown(
                    "# Chat With Agent to search for data tagging in our system 🦙\n"
                    "Try to search for any tags or page, and the agent will find it for you.\n"
                )
                gr.Markdown(
            ...
            examples = gr.Examples(
                examples=["What is the tag of contact user?", "What is the tag of impression ad delivery?"],
                inputs=message,
            )
